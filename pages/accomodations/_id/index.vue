            ...
            <v-container>
                <v-layout row wrap align-center>
                    ...
                    <v-layout column justify-center align-center>
                        ...
                        <v-flex xs12 md3>
                            <h1 style="font-size: 1em" v-for="feature in features" :key="feature"> {{ feature }} </h1><br/>
                        </v-flex>
                        <v-flex xs12 md3>
                            <h1 style="font-size: 1em"> {{ type }} </h1>
                        </v-flex>
                        <v-flex xs12 md3>
                            <star-rating :star-size="20" :rating="rating" :read-only="true" :increment="0.01"></star-rating>
                        </v-flex>
                    </v-layout>
                    </v-flex>
              <v-flex xs12 md6>
...
export default {
  asyncData(context) {
      return new Promise((resolve, reject) => {
          var url = 'http://localhost:3000/fetchAccomodations/' + context.params.id;
          console.log(url);
